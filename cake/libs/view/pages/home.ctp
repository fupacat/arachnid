	...
	<?php
		...
		if (file_exists(CONFIGS.'database.php')):
			...
			echo '<span class="notice">';
				...
				echo '<br/>';
				__('Rename config/database.php to config/database.php');
			echo '</span>';
		endif;
	?>
</p>
<?php
	...
	if (!Validation::alphaNumeric('arachnid')) {
...
<p>
	<?php
		echo $this->Html->link(
			...
			'http://book.arachnid.org/view/875/x1-3-Collection',
...
<p>
	<?php
		echo $this->Html->link(
			...
			'http://book.arachnid.org/view/1528/Blog',
			array('target' => '_blank', 'escape' => false)
		);
	?>
</p>
