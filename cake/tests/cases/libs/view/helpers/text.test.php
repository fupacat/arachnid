 ...
 */
	function testAutoLink() {
		...
		$text = 'Text with a partial www.arachnid.org URL and test@arachnid.org email address';
		$result = $this->Text->autoLink($text);
		$expected = 'Text with a partial <a href="http://www.arachnid.org">www.arachnid.org</a> URL and <a href="mailto:test@arachnid\.org">test@arachnid\.org</a> email address';
		$this->assertPattern('#^' . $expected . '$#', $result);

		$text = 'This is a test text with URL http://www.arachnid.org';
		$expected = 'This is a test text with URL <a href="http://www.arachnid.org">http://www.arachnid.org</a>';
		$result = $this->Text->autoLink($text);
		$this->assertEqual($result, $expected);

		$text = 'This is a test text with URL http://www.arachnid.org and some more text';
		$expected = 'This is a test text with URL <a href="http://www.arachnid.org">http://www.arachnid.org</a> and some more text';
		$result = $this->Text->autoLink($text);
		$this->assertEqual($result, $expected);
		...
		$text = 'This is a test text with URL http://www.arachnid.org';
		$expected = 'This is a test text with URL <a href="http://www.arachnid.org" class="link">http://www.arachnid.org</a>';
		$result = $this->Text->autoLink($text, array('class'=>'link'));
		$this->assertEqual($result, $expected);

		$text = 'This is a test text with URL http://www.arachnid.org';
		$expected = 'This is a test text with URL <a href="http://www.arachnid.org" class="link" id="MyLink">http://www.arachnid.org</a>';
 ...
 */
	function testAutoLinkUrls() {
		...
		$text = 'This is a test that includes (www.arachnid.org)';
		$expected = 'This is a test that includes (<a href="http://www.arachnid.org">www.arachnid.org</a>)';
		$result = $this->Text->autoLinkUrls($text);
		$this->assertEqual($expected, $result);

		$text = 'Text with a partial www.arachnid.org URL';
		$expected = 'Text with a partial <a href="http://www.arachnid.org"\s*>www.arachnid.org</a> URL';
		$result = $this->Text->autoLinkUrls($text);
		$this->assertPattern('#^' . $expected . '$#', $result);

		$text = 'Text with a partial www.arachnid.org URL';
		$expected = 'Text with a partial <a href="http://www.arachnid.org" \s*class="link">www.arachnid.org</a> URL';
		...
		$text = 'Text with a partial WWW.arachnid.org &copy; URL';
		$expected = 'Text with a partial <a href="http://WWW.arachnid.org"\s*>WWW.arachnid.org</a> &copy; URL';
