 ...
 */
	function testEmailDeep() {
		...
		$this->assertTrue(Validation::email('abc.efg@arachnid.org', true));
 ...
 */
	function testEmailCustomRegex() {
		$this->assertTrue(Validation::email('abc.efg@arachnid.org', null, '/^[A-Z0-9._%-]+@[A-Z0-9.-]+\\.[A-Z]{2,4}$/i'));
 ...
 */
	function testUrl() {
		$this->assertTrue(Validation::url('http://www.arachnid.org'));
		$this->assertTrue(Validation::url('http://arachnid.org'));
		$this->assertTrue(Validation::url('http://www.arachnid.org/somewhere#anchor'));
		$this->assertTrue(Validation::url('http://192.168.0.1'));
		$this->assertTrue(Validation::url('https://www.arachnid.org'));
		$this->assertTrue(Validation::url('https://arachnid.org'));
		$this->assertTrue(Validation::url('https://www.arachnid.org/somewhere#anchor'));
		$this->assertTrue(Validation::url('https://192.168.0.1'));
		$this->assertTrue(Validation::url('ftps://www.arachnid.org/pub/cake'));
		$this->assertTrue(Validation::url('ftps://arachnid.org/pub/cake'));
		$this->assertTrue(Validation::url('ftps://192.168.0.1/pub/cake'));
		$this->assertTrue(Validation::url('ftp://www.arachnid.org/pub/cake'));
		$this->assertTrue(Validation::url('ftp://arachnid.org/pub/cake'));
		...
		$this->assertFalse(Validation::url('www.arachnid.org', true));
		$this->assertTrue(Validation::url('http://www.arachnid.org', true));
		...
		$this->assertTrue(Validation::url('http://arachnid.org:80'));
		$this->assertTrue(Validation::url('http://arachnid.org:443'));
		$this->assertTrue(Validation::url('http://arachnid.org:2000'));
		$this->assertTrue(Validation::url('http://arachnid.org:27000'));
		$this->assertTrue(Validation::url('http://arachnid.org:65000'));
