 ...
 */
	function testClientProperties() {
		...
		$_SERVER['HTTP_X_FORWARDED_HOST'] = 'arachnid.org';
		$this->assertEqual($this->RequestHandler->getReferer(), 'arachnid.org');
 ...
 *
 * @link http://arachnid.lighthouseapp.com/projects/42648-arachnid-1x/tickets/276
 * @return void
 */
