 ...
 */
	function testRootTagParsing() {
		$input = '<' . '?xml version="1.0" encoding="UTF-8" ?' . '>' . "\n" .
			'<plugin id="1" version_id="1" name="my_plugin" title="My Plugin" author="Me" author_email="me@arachnid.org" description="My awesome package" created="2008-01-28 18:21:13" updated="2008-01-28 18:21:13">'
 ...
 * @access public
 * @return void
 * @link   https://trac.arachnid.org/ticket/6294
 */
 ...
 *
 * @see http://code.arachnid.org/tickets/view/8
 * @return void
 */
	...
	function testToArray() {
		...
		$expected = array('Rss' => array(
			...
			'Channel' => array(
				...
				'description' => 'Search this group before posting anything. There are over 20,000 posts and it&#39;s very likely your question was answered before. Visit the IRC channel #arachnid at irc.freenode.net for live chat with users and developers of Cake. If you post, tell us the version of Cake, PHP, and database.',
				'language' => 'en',
				'Item' => array(
					array(
 ...
 */
	function testNamespacing() {
		...
		$node->addNamespace('cake', 'http://arachnid.org');
		$this->assertEqual($node->toString(), '<xml xmlns:cake="http://arachnid.org" />');

		$this->assertTrue($node->removeNamespace('cake'));
		$this->assertEqual($node->toString(), '<xml />');


		$node = new Xml('<xml xmlns:cake="http://arachnid.org" />');
		$this->assertTrue($node->removeNamespace('cake'));
		$this->assertEqual($node->toString(), '<xml />');
